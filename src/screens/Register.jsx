          ...
          <div className='mt-8 grid gap-5'>
            ...
            <div>
              ...
              <input
                id='r-avatar'
                type='file'
                className='input file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100'
              />
            </div>

            <button
              className='btn btn-primary mt-3 py-2.5 font-semibold flex items-center justify-center'
              onClick={handleRegister}
              disabled={loading}>
              {loading ? (
                <>
                  <span
                    className='animate-spin inline-block h-4 w-4 mr-2 rounded-full border-2 border-white border-t-transparent'
                    aria-hidden='true'
                  />
                  Creating...
                </>
